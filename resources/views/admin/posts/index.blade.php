	...
	<section id="content">
        ...
        <main>
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a class="active" href="{{ url('/admin/posts') }}">Post</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="table-data" data-aos="fade-up">
                <div class="order">
                    <div class="head">
                        <h3>News & Announcements All Post</h3>
                        <a href="{{ route('admin.posts.create') }}" class="btn btn-primary mb-3">+ Add Task</a>
                    </div>
                ...
                columns: [
                    ...
                    { 
                        ...
                        render: function(data) {
                            return data == 1 ? '<span class="status completed"> News</span>' : '<span class="status pending"> Announc</span>';
                        }
                    },
                    { 
                        data: 'id',
                        render: function(data) {
                            return '<a href="/admin/posts/' + data + '/edit" class="btn btn-primary btn-sm"><i class="bx bxs-edit"></i> Edit</a> ' +

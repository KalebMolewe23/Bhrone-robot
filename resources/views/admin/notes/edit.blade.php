            ...
            <div class="table-data" data-aos="fade-up">
                <div class="order">
                    <form id="note-form" action="{{ route('admin.notes.update', $note->id) }}" method="POST">
                        ...
                        <h4>Content</h4>
                        <div class="form-group">
                            <textarea class="form-control" id="body" name="body">{{ old('body', $note->body) }}</textarea>
                        </div><br>
                        <div class="row mb-5">
                            ...
                            <div style="text-align:right">
                                ...
                                <button type="submit" class="btn btn-primary btn-block"><i class='bx bxs-save' ></i> Update</button>
                            </div>
                        </div>
                    </form>
                </div>
